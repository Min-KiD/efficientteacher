...
#Dataset utils and dataloaders for SSOD training 
...
def load_mosaic_with_M(self, index):
    ...
    for i, index in enumerate(indices):
        ...
        if labels.size:
            ...
            labels[:, 1:] = xywhn2xyxy(labels[:, 1:], w/2, h/2, padw/2, padh/2)  # normalized xywh to pixel xyxy format
...
def random_perspective_with_M(img, targets=(), segments=(), degrees=10, translate=.1, scale=.1, shear=10, perspective=0.0,
    ...
    # print('inside height:', height, ' width:', width)
